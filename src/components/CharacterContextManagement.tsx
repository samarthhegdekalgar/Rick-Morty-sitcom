...
export const CharacterContextProvider: FC<LanguageContextProviderProps> = ({
  children,
  ...
  return <CharacterContext.Provider value={selectedCharacter}>{children}</CharacterContext.Provider>
}
